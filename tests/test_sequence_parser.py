...
def test_enumeration_same_magnitude():
    assert parse_sequence([TC(200, 3, "cardinal"), TC(300, 3, "cardinal")]) == [
        "200",
        "300",
    ]
...
def test_fused_compound():
    assert parse_sequence([TC(2, 0, "cardinal"), TC(1000, 4, "multiplier")]) == ["2000"]
...
def test_large_multiplication():
    assert parse_sequence(
        [TC(5, 0, "cardinal"), TC(1000, 4, "multiplier"), TC(200, 3, "cardinal")]
    ) == ["5200"]


def test_tens_enumeration():
    assert parse_sequence([TC(20, 2, "cardinal"), TC(30, 2, "cardinal")]) == [
        "20",
        "30",
    ]
