...
help:
	...
	@printf "$(GREEN)  build$(NC)              Сборка образа\n"
	@printf "$(YELLOW)  rebuild$(NC)            Пересборка без кэша\n"
	...
	@printf "  $(YELLOW)*必须先 up, чтобы работали run/evaluate/errors/test$(NC)\n"
	@printf "$(CYAN)╰──────────────────────────────────────────────────────────────$(NC)\n"
	@echo ""
	...
	@printf "    make build && make up && make evaluate && make down\n"
